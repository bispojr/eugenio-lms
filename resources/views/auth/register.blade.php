        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ url('/usuario/criar') }}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('perfil') ? ' has-error' : '' }}">
                            <label for="matricula" class="col-md-4 control-label">Perfil</label>

                            <div class="col-md-6">
                                <select id="perfil" type="text" class="form-control" name="perfil" value="{{ old('perfil') }}">
                                     @foreach (App\Perfil::all() as $perfil)
                                        <option>{{ $perfil->nome }}</option>
                                    @endforeach
                                </select>
